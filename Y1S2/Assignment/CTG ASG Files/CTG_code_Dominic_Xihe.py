...
# 3.5 She stores the values of the Nonce generated
# 4.  She sends the nonce values and salt to Bob alongside all the encrypted values
# 5.  Alice encrypts the secret keys with Bob's public key
################ DECRYPTION #################
...
sender_name = "Alice"
receiver_name = "Bob"
password = "I aspire to play the 3rd movement of Moonlight Sonata by the end of this year"
...
ciphertext_plain = cipher.encrypt(password_bytes)                            # Encrypting password with Salsa 20 secret key                                   # nonce values are the same
...
print("Using a different channel to transfer the data")
print("----------------------------------------------")
print("\n")
